...
@section('content')
    <div class="w-full mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div class="rounded-xl overflow-hidden mb-6 alert-shadow alert-gradient-bg">
            <div class="bg-gray-50 hover:bg-gray-100 border-l-4 border-red-500 rounded-lg px-6 py-4 flex items-center justify-between text-black transition-all duration-300">
                ...
                <div class="flex items-center space-x-3 rtl:space-x-reverse">
                    ...
                    <a href="{{ route('employees.alerts.all') }}"
                       class="red-light-btn px-4 py-2 rounded-lg flex items-center space-x-2 rtl:space-x-reverse transition-all">
                            ...
                            <td colspan="8" class="px-6 py-12 text-center">
                                <div class="flex flex-col items-center justify-center text-gray-400">
                                    ...
                                    <p class="text-sm mt-1">
                                        @if(request('search'))
                                            لم يتم العثور على إنذارات تطابق بحثك "{{ request('search') }}"
                                        @else
                                            لم يتم تسجيل أي إنذارات لهذا الموظف
                                        @endif
                                    </p>
                                </div>
                            </td>
