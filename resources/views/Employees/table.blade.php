...
@section('content')
                    ...
                    <div
                        ...
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <div class="export-btn-group no-print">
                                ...
                                <button id="excelImportBtn" class="export-btn" data-bs-toggle="modal" data-bs-target="#importExcelModal">
                                    <span class="btn-icon"><i class="fas fa-file-import"></i></span>
                                    <span class="btn-text">استيراد Excel</span>
                                </button>
                                <!-- PDF Export Button -->
    ...
    <div class="modal fade" id="importExcelModal" tabindex="-1" aria-labelledby="importExcelModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="importExcelModalLabel">استيراد موظفين من ملف Excel</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form id="excelImportForm" action="{{ route('employees.import') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="mb-4">
                            ...
                            <div class="form-text">يجب أن يكون الملف بصيغة Excel (.xlsx أو .xls) ولا يتعدى 10MB</div>
                        </div>

                        <!-- Template Download -->
                        <div class="mb-4">
                            <div class="alert alert-info">
                                <h6 class="alert-heading">📋 تعليمات مهمة للاستيراد:</h6>
                                <ul class="mb-3">
                                    <li>قم بتحميل القالب أولاً واستخدمه لإدخال البيانات</li>
                                    <li>الحقول المميزة ب * <strong>إلزامية</strong></li>
                                    <li>التواريخ يجب أن تكون بصيغة <strong>YYYY-MM-DD</strong> (مثال: 2024-01-15)</li>
                                    <li>الجنس: <strong>ذكر</strong> أو <strong>أنثى</strong></li>
                                    <li>الحالة الوظيفية: <strong>نشط</strong> أو <strong>موقوف</strong></li>
                                    <li>التأكد من عدم تكرار البريد الإلكتروني أو رقم الهوية أو الرقم الوظيفي</li>
                                </ul>
                                <div class="text-center">
                                    <a href="{{ route('employees.template.download') }}" class="btn btn-success">
                        ...
                        <div id="importProgress" class="mb-3" style="display: none;">
                            ...
                            <div class="text-center mt-2" id="progressText">جاري معالجة البيانات...</div>
                        </div>

                        <!-- Results -->
                        <div id="importResults" style="display: none;">
                            <div class="alert" id="resultsAlert">
                                <h6 id="resultsTitle">نتيجة الاستيراد:</h6>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            startImportBtn.addEventListener('click', function() {
                ...
                if (!validTypes.includes(fileExtension)) {
                    showAlert('نوع الملف غير مدعوم. يرجى اختيار ملف Excel (.xlsx أو .xls)', 'danger');
                    return;
                }
                ...
                updateProgress(0, 'جاري معالجة البيانات...');
                ...
                fetch(importForm.action, {
                    ...
                    .then(data => {
                        ...
                        setTimeout(() => showImportResults(data), 500);
                    })
                    .catch(error => {
            ...
            function showImportResults(data) {
                ...
                if (data.success) {
                    ...
                    resultsTitle.innerHTML = '✅ <strong>تم الاستيراد بنجاح</strong>';

                    let html = `
                <div class="mb-3">
                    <p><strong>تم استيراد:</strong> ${data.imported_count} موظف</p>
                    ${data.skipped_count ? `<p><strong>تم تخطي:</strong> ${data.skipped_count} سجل</p>` : ''}
                </div>
            `;
                    ...
                    if (data.errors && data.errors.length) {
                        html += `
                    <div class="mt-3">
                        <h6>⚠️ الأخطاء التي تم تخطيها:</h6>
                        <div class="errors-container" style="max-height: 200px; overflow-y: auto;">
                            <ul class="mb-0">
                ...
                `;
                    ...
                    resultsTitle.innerHTML = '❌ <strong>فشل الاستيراد</strong>';
                ...
                startImportBtn.innerHTML = '<i class="fas fa-upload me-2"></i>بدء الاستيراد';
            }
            ...
            importForm.addEventListener('submit', function(e) {
                ...
                startImportBtn.innerHTML = '<i class="fas fa-spinner fa-spin me-2"></i>جاري الاستيراد...';
            });
        });
        document.addEventListener('DOMContentLoaded', function() {
