                ...
                <table class="table min-w-full divide-y divide-gray-200">
                    ...
                    @forelse($assignments as $index => $assignment)
                        <tr class="assignments-row hover:bg-yellow-50 transition-colors">
                            <td class="assignments-cell px-6 py-4 whitespace-nowrap text-sm text-center text-gray-500">
                                {{ $index + 1 }}
                            </td>
                            ...
                            <td class="assignments-cell px-6 py-4 whitespace-nowrap text-center">
                                <div class="flex flex-col items-center space-y-1">
                                    <a href="{{ route('employees.assignments', $assignment->employee->id) }}"
                                       class="employee-link text-sm font-medium text-gray-900 hover:text-yellow-600">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            liveSearch.addEventListener('input', function() {
                ...
                tableRows.forEach(row => {
                    ...
                    // Get employee name (2nd column), from project (3rd column), and to project (4th column)
                    ...
                    // Check if search term matches employee name OR from project OR to project
                    ...
                    if (matchesEmployee || matchesFromProject || matchesToProject) {
                        row.style.display = '';
                    } else {
            ...
            function exportToExcel() {
                ...
                try {
                    ...
                    XLSX.writeFile(wb, `التكليفات_المؤقتة_${new Date().toISOString().slice(0, 10)}.xlsx`);
            ...
            async function exportToPDF() {
                ...
                try {
                    ...
                    title.textContent = 'تقرير التكليفات المؤقتة';
                    ...
                    const options = {
                        margin: [15, 15, 20, 15],
                        filename: `التكليفات_المؤقتة_${new Date().toISOString().slice(0, 10)}.pdf`,
                        image: {
                            type: 'jpeg',
                            quality: 0.98
                        },
