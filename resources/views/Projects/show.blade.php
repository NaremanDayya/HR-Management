...
@section('content')
    ...
    <div class="w-full rtl p-6 bg-gray-50 min-h-screen">
        ...
        <div
            class="bg-gray-100 hover:bg-purple-200 border-black border-2 rounded-2xl p-6 mb-8 transition-all duration-300 shadow-md">
            >
            ...
            <div
                class="flex border-black border-2 flex-col lg:flex-row items-center justify-between gap-6 bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
                <div class="flex flex-wrap items-center justify-center gap-2 mt-4">
                    ...
                    <div
                        ...
                        <span
                            class="inline-flex items-center justify-center w-6 h-6 text-xs font-bold rounded-full bg-green-400 text-black">
                    ...
                    <div
                        ...
                        <span
                            class="inline-flex items-center justify-center w-6 h-6 text-xs font-bold rounded-full bg-red-400 text-black">
                ...
                <div class="w-full lg:w-auto">
                    <div class="flex flex-wrap  justify-center gap-3">
                        <a href="{{ route('projects-statistics') }}"
                           class="px-5 py-2.5 border-2 border-black text-sm font-bold rounded-full transition-all transform hover:scale-105
                            ...
                            <ul x-show="open" @click.away="open = false" x-transition
                                ...
                                <template x-for="(label, value) in options" :key="value">
                                    <li @click="selected = label; open = false; applyFilter(value, 'account_status')"
                                        ...
                                        <svg x-show="selected === label" class="w-4 h-4 text-blue-500"
                                             fill="currentColor"
                                             viewBox="0 0 20 20">
                                            <path fill-rule="evenodd"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            <section class="bg-white rounded-xl shadow-lg p-6 hover:shadow-indigo-300 transition-shadow duration-300">
                ...
                <div class="overflow-x-auto">
                    <table id="nationalitiesTable"
                           class="min-w-full border-collapse border border-gray-300 text-center">
                        <thead
                            class="bg-indigo-50 hover:bg-indigo-100 border-l-4 border-indigo-500 text-black text-lg rounded-t-xl">
                        <tr>
            ...
            <section class="bg-white rounded-xl shadow-lg p-6 hover:shadow-green-300 transition-shadow duration-300">
                ...
                <div class="overflow-x-auto">
                    <table id="ageGroupsTable" class="min-w-full border-collapse border border-gray-300 text-center">
                        <thead
                            class="bg-green-50 hover:bg-green-100 border-l-4 border-green-500 text-black text-lg rounded-t-xl">
                        <tr>
            ...
            <section class="bg-white rounded-xl shadow-lg p-6 hover:shadow-indigo-300 transition-shadow duration-300">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8 mr-4">
                    ...
                    <div
                        class="bg-blue-50 rounded-lg p-4 shadow-sm hover:shadow-md transition-all border border-blue-100">
                        <div class="flex items-center justify-between mb-2">
            ...
            <section class="bg-white rounded-xl shadow-lg p-6 hover:shadow-purple-300 transition-shadow duration-300">
                ...
                <div class="overflow-x-auto">
                    <table id="rolesTable" class="min-w-full border-collapse border border-gray-300 text-center">
                        <thead
                            class="bg-purple-50 hover:bg-purple-100 border-l-4 border-purple-500  text-black text-lg rounded-t-xl">
                        <tr>
