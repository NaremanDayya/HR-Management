...
class PublicProjectManagerRegistrationRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'new_project_name.required' => 'يجب إدخال اسم المشروع الذي ستديره',
            'new_project_name.unique' => 'يوجد مشروع بهذا الاسم مسبقًا، يرجى اختيار اسم آخر',
        ];
    }
